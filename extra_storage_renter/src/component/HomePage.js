    ...
    return (
      <ScrollView style={styles.container}>
        ...
        <View style={styles.center}>
            ...
            <View style={styles.centerItemInner}>
              <TouchableOpacity onPress={() => navigate ('ProductsOverview')}>
                <Image
                  ...
                  source={require ('../../assets/icon/016-magnifying-glass.png')}
                />
                <Text textAlign="center">FIND NEARBY</Text>
              </TouchableOpacity>
            </View>
          </View>
          ...
          <View style={styles.centerItem}>
            <View style={styles.centerItemInner}>
              <TouchableOpacity onPress={() => navigate ('MapScreen')}>
                <Image
                  style={styles.itemIcon}
                  source={require ('../../assets/icon/011-street-map.png')}
                />
          ...
          <View style={styles.centerItem}>
            <View style={styles.centerItemInner}>
              <TouchableOpacity onPress={() => navigate ('OrdersScreen')}>
                <Image
                  style={styles.itemIcon}
